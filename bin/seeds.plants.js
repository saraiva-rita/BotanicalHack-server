...
const allPlants = [
  {
    ...
    care: {
      light: `Calathea orbifolia prefers bright, indirect light. Avoid direct sunlight, as it can scorch the leaves. It's best suited for areas with filtered or dappled sunlight. Low light conditions may lead to reduced growth and less vibrant foliage.`,
      watering: `Keep the soil consistently moist but not waterlogged. Water when the top inch of soil feels dry. Ensure that the pot has good drainage to prevent root rot. Calathea orbifolia appreciates higher humidity levels, so consider using a humidity tray or misting the leaves regularly.`,
      temperature: `Calathea orbifolia thrives in temperatures between 65-75°F (18-24°C). Protect it from cold drafts and keep it away from temperatures below 60°F (15°C).`,
      ...
      fertilizing: `Feed Calathea orbifolia every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble fertilizer diluted to half strength. Avoid fertilizing during the winter months.`,
    },
  ...
  },
  {
    ...
    description: `Calathea medallion is a captivating tropical houseplant known for its ornate foliage. The leaves are round, broad, and feature intricate patterns of green, dark green, and various shades of pink or burgundy. The markings on the leaves resemble medallions, which is how it gets its common name.`,
    image: '/images/calathea-medallion.png',
    care: {
      light: `Calathea medallion thrives in bright, indirect light. Avoid direct sunlight, as it can scorch the leaves and cause them to lose their vibrant coloration. It's best suited for areas with filtered or dappled sunlight. Low light conditions may lead to reduced growth and less vibrant foliage`,
      watering: `Keep the soil consistently moist but not waterlogged. Water when the top inch of soil feels dry. Ensure that the pot has good drainage to prevent root rot. Calathea medallion appreciates higher humidity levels, so consider using a humidity tray or misting the leaves regularly.`,
      temperature: `Calathea medallion prefers temperatures between 65-75°F (18-24°C). It's sensitive to cold drafts and should be protected from temperatures below 60°F (15°C).`,
      soil: `Plant Calathea medallion in a well-draining, peat-based potting mix. The mix should retain moisture but also provide good aeration for the roots.`,
      seasonalCare: `Humidity: Maintain higher humidity levels around the plant, especially during the dry winter months. Use a humidifier or place the pot on a humidity tray.
      Pruning: Remove any brown or damaged leaves to encourage healthy growth and maintain the plant's appearance.
      Cleaning: Wipe the leaves regularly with a damp cloth to remove dust and keep the foliage looking vibrant.
      Winter Care: Reduce watering and avoid fertilizing during the winter when the plant is in a semi-dormant state.`,
      fertilizing: `Feed Calathea medallion every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble fertilizer diluted to half strength. Avoid fertilizing during the winter months.`,
    },
    tips: `Temperature Sensitivity: Protect the plant from temperature fluctuations and drafts, which can cause stress and leaf damage.
    Grouping: Grouping it with other plants can help create a microclimate with higher humidity levels.
    Rotation: Rotate the plant periodically to ensure even growth and prevent it from leaning toward the light source.
  ...
  },
  {
    ...
    description: `Calathea makoyana, commonly known as the "Peacock Plant" or "Cathedral Windows," is a stunning tropical houseplant appreciated for its intricately patterned foliage. Its leaves feature a beautiful combination of green, cream, and purple hues, with a pattern that resembles peacock feathers, giving it its common name.`,
    image: '/images/calathea-makoyana.png',
    care: {
      light: `Calathea makoyana thrives in bright, indirect light. Avoid direct sunlight, as it can scorch the leaves. This plant is particularly well-suited for areas with filtered or dappled sunlight.`,
      ...
      temperature: `Calathea makoyana prefers temperatures between 65-75°F (18-24°C). It is sensitive to cold drafts and should be protected from temperatures below 60°F (15°C).`,
      soil: `Plant Calathea makoyana in a well-draining, peat-based potting mix. The mix should retain moisture but also provide good aeration for the roots.`,
      ...
      `,
      fertilizing: `Feed Calathea makoyana every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble fertilizer diluted to half strength. Avoid fertilizing during the winter months when the plant is in a semi-dormant state.`,
    },
  ...
  },
  {
    ...
    description: `Calathea triostar, also known as the "Triostar Stromanthe" or "Stromanthe sanguinea triostar," is a captivating tropical houseplant cherished for its striking foliage. Its leaves are lance-shaped with vibrant shades of pink, cream, and green, creating a stunning tricolor effect. The undersides of the leaves are typically a deep maroon or burgundy color.`,
    image: '/images/calathea-triostar.jpg',
    care: {
      light: `Calathea triostar thrives in bright, indirect light. It can tolerate some filtered sunlight but should be protected from direct sun exposure, which can scorch its leaves. This plant is best suited for areas with ample natural light but not harsh, direct sunlight.`,
      watering: `Keep the soil consistently moist but not waterlogged. Water when the top inch of soil feels slightly dry. Ensure that the pot has good drainage to prevent root rot. Maintaining higher humidity levels is essential for this plant's health, so consider using a humidity tray or misting the leaves regularly.`,
      temperature: `Calathea triostar prefers temperatures between 65-75°F (18-24°C). It is sensitive to cold drafts and should be protected from temperatures below 60°F (15°C).`,
      soil: `Plant Calathea triostar in a well-draining, peat-based potting mix. The mix should retain moisture but also provide good aeration for the roots.`,
      seasonalCare: `Humidity: Maintain higher humidity levels around the plant, especially during the dry winter months. Use a humidifier or place the pot on a humidity tray.
      Pruning: Remove any brown or damaged leaves to encourage healthy growth and maintain the plant's appearance.
      Cleaning: Wipe the leaves regularly with a damp cloth to remove dust and keep the foliage looking vibrant.
      Winter Care: Reduce watering and avoid fertilizing during the winter when the plant is in a semi-dormant state.`,
      fertilizing: `Feed Calathea triostar every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble fertilizer diluted to half strength. Avoid fertilizing during the winter months.`,
    },
    tips: `Temperature Sensitivity: Protect the plant from temperature fluctuations and drafts, which can cause stress and leaf damage.
    Grouping: Grouping it with other plants can help create a microclimate with higher humidity levels.
    Rotation: Rotate the plant periodically to ensure even growth and prevent it from leaning toward the light source.
  ...
  },
  {
    ...
    description: `Calathea zebrina, often referred to as the "Zebra Plant" or "Zebra Prayer Plant," is a distinctive and visually striking houseplant known for its bold, zebra-like patterns on its leaves. The leaves are elongated and have a deep green color with contrasting light green stripes or markings. The undersides of the leaves are often maroon, adding to its overall appeal. This plant belongs to the Marantaceae family, which includes various species with captivating foliage.`,
    image: '/images/calathea-zebrina.png',
    care: {
      light: `Calathea zebrina prefers bright, indirect light. It thrives in filtered sunlight or moderate shade. Avoid exposing it to direct sunlight, as this can scorch the leaves. Inadequate light can lead to less vibrant leaf patterns and slower growth.`,
      watering: `Keep the soil consistently moist but not waterlogged. Water when the top inch of soil feels slightly dry. Use room-temperature water and ensure proper drainage to prevent root rot. Maintaining higher humidity levels around the plant is crucial, so consider using a humidity tray, misting the leaves, or using a room humidifier.`,
      temperature: `Calathea zebrina prefers temperatures between 65-75°F (18-24°C). It is sensitive to temperature extremes and should be protected from drafts and temperatures below 60°F (15°C).`,
      soil: `Plant in a well-draining, peat-based potting mix. A mix formulated for tropical plants or African violets is suitable. Good soil aeration is essential.`,
      ...
      fertilizing: `Feed Calathea zebrina every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization during the winter months.`,
    },
  ...
  },
  {
    ...
    description: `Calathea sanderiana is a striking and elegant houseplant known for its eye-catching foliage. It belongs to the Marantaceae family and features lance-shaped leaves with a beautiful combination of dark green and silver-green stripes. The undersides of the leaves are often maroon, adding to its aesthetic appeal. When in low light or at night, the leaves fold upward, revealing the maroon undersides, and then unfurl again during the day.`,
    image: '/images/calathea-sanderiana.png',
    care: {
      light: `Calathea sanderiana thrives in bright, indirect light. It prefers filtered sunlight or moderate shade. Avoid exposing it to direct sunlight, as this can scorch the leaves. Inadequate light can result in faded leaf colors and slower growth.`,
      watering: `Keep the soil consistently moist but not waterlogged. Water when the top inch of soil feels slightly dry. Use room-temperature water and ensure that the pot has proper drainage to prevent root rot. Calathea sanderiana appreciates higher humidity levels, so consider using a humidity tray, misting the leaves, or using a room humidifier to maintain adequate moisture.`,
      temperature: `Calathea sanderiana prefers temperatures between 65-75°F (18-24°C). Protect it from cold drafts, and avoid temperatures below 60°F (15°C).`,
      ...
      Winter Care: Reduce watering and avoid fertilizing during the winter when the plant's growth naturally slows.
      `,
      fertilizing: `Feed Calathea sanderiana every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization during the winter months.`,
    },
    tips: `Humidity: Consistently high humidity is important for this plant's well-being. Ensure proper humidity levels to prevent leaf browning and curling.
    Rotation: Rotate the plant periodically to ensure even growth and prevent it from leaning toward the light source.
    Pest Management: Keep an eye out for common indoor plant pests like spider mites and mealybugs, and treat promptly if you notice any infestations.
  ...
  },
  {
    ...
    description: `Calathea rufibarba, commonly known as the "Velvet Calathea" or "Fuzzy Feather Calathea," is a striking tropical houseplant recognized for its unique and attractive features. It has elongated, lance-shaped leaves with a rich, velvety texture on the upper side and a deep purple hue on the underside. The plant's fuzzy appearance and rich coloration make it a popular choice among indoor plant enthusiasts.`,
    image: '/images/calathea-rufibarba.png',
    care: {
      light: `Calathea rufibarba thrives in bright, indirect light. It prefers filtered or dappled sunlight. Protect it from direct sunlight, as intense sun can scorch the leaves. Inadequate light can result in less vibrant foliage and slower growth.`,
      ...
      temperature: `Calathea rufibarba prefers temperatures between 65-75°F (18-24°C). Avoid exposing it to cold drafts and temperatures below 60°F (15°C).`,
      soil: `Plant Calathea rufibarba in a well-draining, peat-based potting mix. The mix should retain moisture but also provide good aeration for the roots.`,
      ...
      Winter Care: Reduce watering and avoid fertilizing during the winter when the plant is in a semi-dormant state.`,
      fertilizing: `Feed Calathea rufibarba every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble fertilizer diluted to half strength. Reduce or cease fertilization during the winter months when growth is slower.`,
    },
    tips: `Temperature Sensitivity: Protect the plant from temperature fluctuations and drafts, which can cause stress and leaf damage.
    Grouping: Grouping it with other plants can help create a microclimate with higher humidity levels.
    Rotation: Rotate the plant periodically to ensure even growth and prevent it from leaning toward the light source.
  ...
  },
  {
    ...
    description: `Calathea White Fusion is a striking and highly sought-after tropical houseplant known for its exquisite foliage. It features broad, lance-shaped leaves with a mesmerizing combination of green, cream, and various shades of pink or purple. The unique variegation on its leaves resembles brush strokes, giving it an artistic and captivating appearance.`,
    image: '/images/calathea-white-fusion.png',
    care: {
      light: `Calathea White Fusion thrives in bright, indirect light. It appreciates ample natural light but should be protected from direct sunlight, which can harm the delicate leaves. Inadequate light can lead to less vibrant variegation.`,
      ...
      temperature: `Calathea White Fusion prefers temperatures between 65-75°F (18-24°C). It's sensitive to cold drafts and should be shielded from temperatures below 60°F (15°C).`,
      soil: `Plant Calathea White Fusion in a well-draining, peat-based potting mix. The mix should retain moisture but also provide good aeration for the roots.`,
      seasonalCare: `Humidity: Maintain higher humidity levels around the plant, especially during the dry winter months. Increased humidity helps prevent leaf browning and curling.
      Pruning: Prune to remove any brown or damaged leaves and to encourage healthy growth.
      Cleaning: Wipe the leaves regularly with a damp cloth to remove dust and maintain their vibrant appearance.
      Winter Care: Reduce watering and avoid fertilizing during the winter when the plant is in a semi-dormant state.`,
      fertilizing: `Feed Calathea White Fusion every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization during the winter months when growth is slower.`,
    },
  ...
  },
  {
    ...
    description: `Calathea oppenheimiana is a striking and ornamental houseplant known for its lush foliage. It belongs to the Marantaceae family. The plant features large, oval-shaped leaves with prominent dark green veins on a lighter green background. The undersides of the leaves are often reddish-purple, adding to its visual appeal. Calathea oppenheimiana is renowned for its unique and intricate leaf patterns, making it a popular choice among plant enthusiasts.`,
    image: '/images/calathea-oppenheimiana.png',
    care: {
      light: `Calathea oppenheimiana prefers bright, indirect light. It thrives in well-lit areas with filtered sunlight. Avoid exposing it to direct sun, as this can scorch the leaves. Inadequate light may result in less vibrant foliage and slower growth.`,
      ...
      temperature: `Maintain indoor temperatures between 65-75°F (18-24°C) for Calathea oppenheimiana. Protect it from drafts and temperature extremes, as it prefers consistent conditions.`,
      ...
      seasonalCare: `Humidity: Calathea oppenheimiana appreciates higher humidity levels. You can increase humidity by misting the plant, using a humidity tray, or placing a humidifier nearby.
      Cleaning: Wipe the leaves regularly with a damp cloth to remove dust and maintain their glossy appearance.`,
      fertilizing: `Feed Calathea oppenheimiana every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization in the winter when growth is slower.`,
    },
    ...
    Prayer Plant Behavior: Calathea oppenheimiana is sometimes referred to as a "prayer plant" due to its habit of folding its leaves upward at night. This is a natural behavior and not a cause for concern.
    Pest Management: Keep an eye out for common indoor plant pests like spider mites and mealybugs, and treat promptly if you notice any infestations.`,
  },
  {
    name: 'Calathea Insigne',
    description: `Calathea Insigne, also known as the "Rattlesnake Plant," is a stunning and popular tropical houseplant admired for its striking foliage. It features lance-shaped leaves with a dark green background adorned with beautiful, wavy, and light green patterns that resemble the skin of a rattlesnake. The contrasting colors and intricate markings make it a visually appealing addition to indoor spaces.`,
    image: '/images/calathea-insigne.png',
    care: {
      light: `Calathea Insigne prefers bright, indirect light. It thrives in filtered sunlight or moderate shade. Avoid direct sunlight, as it can scorch the leaves. Inadequate light can result in faded leaf patterns and slower growth.`,
      watering: `Keep the soil consistently moist but not waterlogged. Water when the top inch of soil feels slightly dry. Use room-temperature water and avoid allowing the plant to sit in standing water, which can lead to root rot. Maintaining higher humidity levels is crucial for this plant's health, so consider using a humidity tray, misting the leaves regularly, or using a room humidifier.`,
      temperature: `Calathea Insigne prefers temperatures between 65-80°F (18-27°C). It is sensitive to cold drafts and should be protected from temperatures below 60°F (15°C).`,
      soil: `Plant Calathea Insigne in a well-draining, peat-based potting mix. The mix should retain moisture but also provide good aeration for the roots.`,
      seasonalCare: `Humidity: Maintain higher humidity levels around the plant, especially during the dry winter months. Increased humidity helps prevent leaf browning and curling.
      Pruning: Prune to remove any brown or damaged leaves and to encourage healthy growth.
      Cleaning: Wipe the leaves regularly with a damp cloth to remove dust and maintain their vibrant appearance.
      Winter Care: Reduce watering and avoid fertilizing during the winter when the plant is in a semi-dormant state.`,
      fertilizing: `Feed Calathea Insigne every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization during the winter months when growth is slower.`,
    },
    tips: `Humidity: Ensure a humid environment, as this plant thrives in higher humidity levels. You can use a humidity tray, room humidifier, or mist the leaves regularly.
    Temperature Sensitivity: Protect the plant from temperature fluctuations and drafts.
    Grouping: Grouping it with other plants can help create a microclimate with higher humidity levels.
  ...
  },
  {
    ...
    description: `: Epipremnum aureum 'Manjula,' also known as "Manjula Pothos" or "Manjula Devil's Ivy," is a popular and visually stunning cultivar of the common Pothos plant. It is characterized by its striking variegated foliage, featuring heart-shaped leaves with shades of green, creamy-white, and silver-gray. The variegation varies from leaf to leaf, creating a unique and eye-catching appearance.`,
    image: '/images/manjula.png',
    care: {
      light: `Manjula Pothos thrives in medium to bright, indirect light. It can tolerate lower light conditions but may grow more slowly and display less vibrant variegation. Avoid direct sunlight, as it can scorch the leaves.`,
      ...
      temperature: `Manjula Pothos prefers temperatures between 65-80°F (18-27°C). It can tolerate slightly cooler temperatures but should be protected from drafts and temperatures below 50°F (10°C).`,
      soil: `Plant Manjula Pothos in well-draining potting mix. A mix formulated for houseplants or a general-purpose potting mix is suitable. Good soil aeration is important for root health.`,
      seasonalCare: `Pruning: Prune as needed to maintain the desired shape and size. Trimming also encourages bushier growth.
      Cleaning: Wipe the leaves regularly with a damp cloth to remove dust and maintain their vibrant appearance.
      Winter Care: Reduce watering and avoid fertilizing during the winter when the plant's growth naturally slows.`,
      fertilizing: `Feed Manjula Pothos every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization during the winter months when growth is slower.`,
    },
  ...
  },
  {
    ...
    description: `Dracaena marginata 'Sunray,' also known as the "Sunray Madagascar Dragon Tree," is a visually striking and popular indoor plant. It is a cultivar of the Dracaena marginata species. This plant is recognized for its slender, upright stems with clusters of arching, sword-shaped leaves. The leaves have a vibrant and distinctive coloration, featuring green centers with bright yellow to creamy margins, hence the name "Sunray."`,
    image: '/images/dracaena-marginata.png',
    care: {
      light: `Dracaena marginata 'Sunray' prefers bright, indirect light. It can tolerate some direct sunlight, but prolonged exposure to harsh sun can scorch the leaves. Inadequate light can lead to leggy growth and faded leaf color. This plant can also adapt to lower light conditions, although its growth may slow.`,
      watering: `Allow the top inch or so of the soil to dry out between waterings. Water thoroughly when needed, and ensure proper drainage to prevent waterlogged roots. Avoid overwatering, as Dracaenas are susceptible to root rot.`,
      temperature: `Dracaena marginata 'Sunray' does well in average indoor temperatures between 65-80°F (18-27°C). It's sensitive to cold drafts and should be protected from temperatures below 50°F (10°C).`,
      ...
      fertilizing: `Feed Dracaena marginata 'Sunray' every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization during the winter months when growth is slower.`,
    },
  ...
  },
  {
    ...
    care: {
      ...
      watering: `Allow the top inch or so of the soil to dry out between waterings. Water thoroughly when the soil feels dry to the touch, and ensure that excess water drains away. Pothos prefers to remain slightly moist but not waterlogged. It is more forgiving of underwatering than overwatering.`,
      temperature: `Pothos prefers indoor temperatures between 65-80°F (18-27°C). It can tolerate slightly cooler conditions but should be protected from drafts and temperatures below 50°F (10°C).`,
      ...
      fertilizing: `Feed Pothos every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization during the winter when growth is slower.`,
    },
  ...
  {
    name: `Alocasia Polly`,
    description: `Alocasia Polly, also known as African Mask Plant or Elephant Ear, is a striking tropical plant appreciated for its glossy, arrow-shaped leaves. The leaves are deep green with contrasting white to silvery veins, resembling the patterns on a mask, hence the common name "African Mask Plant."`,
    image: '/images/alocasia-polly.png',
    care: {
      light: `Alocasia Polly prefers bright, indirect light. It can tolerate some direct morning sun, but intense sunlight should be avoided, as it can scorch the leaves.`,
      ...
      temperature: `Alocasia Polly thrives in warm temperatures between 65-80°F (18-27°C). Avoid exposing it to temperatures below 60°F (15°C).`,
      soil: `Plant Alocasia Polly in a well-draining potting mix rich in organic matter. A mix designed for aroids or tropical plants works well.`,
      seasonalCare: `In the growing season (spring and summer), Alocasia Polly appreciates higher humidity levels. You can achieve this by misting the leaves regularly or placing a humidity tray nearby. During the winter, reduce watering and provide slightly cooler temperatures.`,
      fertilizing: `Feed Alocasia Polly every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble fertilizer diluted to half strength.`,
    },
    tips: `Humidity: Maintain higher humidity levels to mimic its tropical habitat.
    Pot Size: Alocasia Polly prefers slightly tight quarters. Repotting is usually necessary every 2-3 years.
  ...
  },
  {
    ...
    description: `Begonia maculata, commonly known as the Polka Dot Begonia or Angel Wing Begonia, is an eye-catching houseplant. It is recognized for its unique foliage, which features large, asymmetrical, angel-wing-shaped leaves adorned with silvery-white spots and deep green coloration. This begonia can also produce clusters of delicate pink or white flowers, though it's primarily grown for its striking leaves.`,
    image: '/images/begonia-maculata.png',
    care: {
      light: `Begonia maculata thrives in bright, indirect light. It should be shielded from direct sunlight, which can scorch its leaves. East or west-facing windows with filtered light are ideal.`,
      ...
      temperature: `Begonia maculata prefers temperatures between 65-75°F (18-24°C). It's sensitive to cold drafts and should be kept away from drafts and temperatures below 60°F (15°C).`,
      ...
      fertilizing: `Feed Begonia maculata with a balanced, water-soluble fertilizer diluted to half strength every 4-6 weeks during the growing season (spring and summer). Avoid fertilizing during the winter when the plant is resting.`,
    },
    ...
    Propagation: Begonia maculata can be propagated through stem cuttings. Take cuttings with a few leaves attached and root them in a well-draining medium.
  ...
  },
  {
    ...
    description: `Alocasia zebrina, also known as the "Zebra Plant" or "Elephant Ear," is a striking tropical houseplant prized for its unique and dramatic foliage. It features large, arrowhead-shaped leaves with bold green veins and striking zebra-like stripes that resemble the pattern of a zebra's skin. The plant's stems are also marked with contrasting zebra stripes.`,
    image: '/images/alocasia-zebrina.jpg',
    care: {
      light: `Alocasia zebrina thrives in bright, indirect light. It can tolerate some morning or evening sun, but protect it from harsh, direct sunlight, which can scorch the leaves. Inadequate light can lead to leggy growth and smaller leaves.`,
      ...
      temperature: `Alocasia zebrina prefers temperatures between 65-75°F (18-24°C). It is sensitive to cold drafts and should be protected from temperatures below 60°F (15°C).`,
      soil: `Plant Alocasia zebrina in a well-draining, peat-based potting mix. A mix formulated for aroids or tropical plants works well. Ensure the pot has good drainage.`,
      ...
      Cleaning: Wipe the leaves regularly with a damp cloth to remove dust and maintain their vibrant appearance.
      Winter Care: Reduce watering and avoid fertilizing during the winter when the plant's growth naturally slows.`,
      fertilizing: `Feed Alocasia zebrina every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization during the winter months when growth is slower.`,
    },
  ...
  },
  {
    ...
    description: `Schismatoglottis Wallichii is a striking tropical houseplant known for its distinctive foliage. It belongs to the Araceae family and is recognized for its large, arrow-shaped leaves that typically have a deep green color and prominent veining. The leaves are glossy and may have a slightly leathery texture. Schismatoglottis Wallichii is valued for its attractive and unique appearance.`,
    image: '/images/schismatoglottis-wallichii.png',
    care: {
      light: `Schismatoglottis Wallichii thrives in bright, indirect light. It prefers filtered or dappled sunlight. Avoid exposing it to direct sunlight, as intense sun can scorch the leaves. Inadequate light can result in slower growth and less vibrant foliage.`,
      ...
      temperature: `Schismatoglottis Wallichii prefers temperatures between 65-80°F (18-27°C). Protect it from cold drafts and temperatures below 60°F (15°C).`,
      soil: `Plant Schismatoglottis Wallichii in a well-draining, peat-based potting mix. The mix should retain moisture while also providing good aeration for the roots.`,
      seasonalCare: `Humidity: Maintain higher humidity levels around the plant, especially during the dry winter months. Use a humidity tray, room humidifier, or mist the leaves regularly.
      Pruning: Prune to remove any brown or damaged leaves and to encourage healthy growth.
      Cleaning: Wipe the leaves with a damp cloth to remove dust and maintain their glossy appearance.
      Winter Care: Reduce watering and avoid fertilizing during the winter when the plant is in a semi-dormant state.`,
      fertilizing: `Feed Schismatoglottis Wallichii every 4-6 weeks during the growing season (spring and summer) with a balanced, water-soluble houseplant fertilizer diluted to half strength. Reduce or cease fertilization during the winter months when growth is slower.`,
    },
